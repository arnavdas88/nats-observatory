...
from nats_observe import VERSION, VERSION_SHORT  # noqa: E402

# -- Project information -----------------------------------------------------

project = "nats-observatory"
...
html_title = f"nats-observatory v{VERSION}"
...
html_theme_options = {
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/arnavdas88/nats-observatory",
            "html": """
